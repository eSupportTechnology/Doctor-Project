     ...
     <div className="items-center justify-between mt-2 space-y-3 md:flex md:space-x-3 md:space-y-0">
      ...
      <table className="w-full border border-collapse border-gray-200 shadow-md table-auto border-l-[1px] border-l-[#98DED9]">
       ...
       <div className='flex'>
            ...
            <div className='bg-[#EEFF01] mt-3 border-[1px] border-black xl:w-[780px] w-[290px]'>
             ...
             className='bg-[#0004FF] text-white xl:ml-[600px] ml-[200px] px-4 my-1 rounded border-[1px] border-[#00014B] hover:bg-[#4042b8]'>Send</button>
            </div>    
       </div>
       ...
       <div className='flex'>
            ...
            <div className='bg-[#EEFF01] mt-3 border-[1px] border-black xl:w-[780px] w-[290px] h-[130px]'>
            ...
            <button 
            onClick={() => sendMessage(selectedMessage)}
            className='bg-[#0004FF] text-white xl:ml-[600px] ml-[200px] xl:my-0 my-2 px-4 rounded border-[1px] border-[#00014B] hover:bg-[#4042b8]'>Send</button>
            </div>    
       </div>
       ...
       <div className='flex'>
            ...
            <div className='bg-[#EEFF01] mt-3 border-[1px] border-black xl:w-[780px] w-[290px] xl:h-[34px]'>
             <input type="text" placeholder='Type Here If You Want To Send Message For Patient.' 
             className='bg-[#EEFF01] xl:w-[602px] w-[285px] h-[32px]'
             value={customMessage}
             onChange={(e) => setCustomMessage(e.target.value)}/>
             <button 
             className='bg-[#0004FF] text-white px-4 rounded border-[1px] border-[#00014B] hover:bg-[#4042b8] xl:my-0 my-2 xl:ml-0 ml-[213px]'
